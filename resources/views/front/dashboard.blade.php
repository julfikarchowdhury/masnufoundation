...
@section('content')
        ...
        <section class="container-fluid px-5 py-2 " style="background-color:#f2f2f2;">
            <div class=" px-5 ">
                <form class="container row mx-auto g-3 my-5 shadow-sm py-3 rounded div-white">
                    <div class="col-auto ms-3">
                        <input type="search" class="form-control" placeholder="Donate fund">
                    </div>
                    <div class="col-auto ms-4 ">
                        <input type="email /phone" class="form-control" placeholder="email / phone">
                    </div>
                    <div class="col-auto ms-4 ">
                        <input type="number" class="form-control" placeholder="Donate Amount">
                    </div>
                    <div class="col-auto ms-3 ">
        ...
        <section class="container-fluid p-5 bg-light">
            ...
            <div class="row ">
                ...
                <div class="card col-4 m-2 border-0 shadow-sm" style="width:21rem;">
                    ...
                    <div class="card-body">
                        <h4 class="card-title" style="text-align: center;padding:10px;color:green;">{{$project->name}}</h4>
